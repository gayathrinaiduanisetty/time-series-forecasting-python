...
Gayathri Anisetty is an AI/ML Engineer with over 4 years of experience developing machine learning, NLP, and Generative AI applications. Skilled in Python, PyTorch, and TensorFlow, she has extensive experience building RAG pipelines and transformer-based models. Her expertise includes deploying scalable solutions using AWS SageMaker, Docker, and MLflow, with a focus on integrating AI models into production environments to improve inference performance and business outcomes.